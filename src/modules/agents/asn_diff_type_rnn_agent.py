...
class AsnDiffRnnAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(AsnDiffRnnAgent, self).__init__()
        self.args = args
        ...
        self.enemies_info2_fc1 = nn.Linear(args.enemy_feats_size, args.asn_hidden_size)
        self.enemies_info2_fc2 = nn.Linear(args.asn_hidden_size, args.asn_hidden_size)
        self.enemies_info2_rnn3 = nn.GRUCell(args.asn_hidden_size, args.asn_hidden_size)
