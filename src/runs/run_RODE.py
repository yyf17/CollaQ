...
from utils.util import get_game_name
...
def run(_run, _config, _log):
    ...
    game_name,unique_token = get_game_name(args)
...
def run_sequential(args, logger):
    ...
    # setup RelayBuffer ,RODE 采用标准的ReplayBuffer,所以--git-root=CollaQ
    #                               同时      component: 跟default_CollaQ中的component一样
