...
class BasicMAC:
    def __init__(self, scheme, groups, args):
        ...
        if args.git_root in ["CollaQ"]:
            ...
            self._build_agents(self.input_shape, input_alone_shape=self.input_alone_shape)
        else:  # "AIQMIX","LICA","QPLEX"
    ...
    # modify , **kwargs
    def forward(self, ep_batch, t, test_mode=False, return_logits=True, **kwargs):
        # for AIQMIX
        ...
        if self.agent_output_type == "pi_logits":
            ...
            if (self.args.git_root in ["LICA"] ) and return_logits:
            ...
            if self.args.git_root in ["LICA"]:
                ...
                if not test_mode:
                    ...
                    if getattr(self.args, "mask_before_softmax", True):
                        ...
                        elif self.args.git_root in ["ASN"]:
                            # Zero out the unavailable actions
                            if self.args.legal_action:
    ...
    def _build_agents(self, input_shape,input_alone_shape=None):
        if self.args.git_root in ["CollaQ"]:
