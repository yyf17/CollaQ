...
class QLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.optimiser = RMSprop(params=self.params, lr=args.lr, alpha=args.optim_alpha, eps=args.optim_eps, weight_decay=getattr(self.args,"weight_decay",0) )
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        if self.args.double_q:
            ...
            elif self.args.git_root in ["AIQMIX"]:
